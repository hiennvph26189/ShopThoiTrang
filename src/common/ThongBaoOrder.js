...
const ThongBaoOrder = (props) => {
  const navigation = useNavigation()
    ...
    let data_9pay = route.params.utf8String
    ...
    const payOrder9Pay = async()=>{
      ...
      if(data_9pay && data_9pay.status == 5 &&data2){
        let post_data = {
            data2:data2,
            arrTenSp:arrTenSp,
            data_9pay:data_9pay
    ...
    return (
        <View style={{padding:10}}>
          ...
          <View>
              ...
              <View style={{padding:10, marginTop:10}}>
                  ...
                  <View style={{ borderBottomWidth: 1, borderBottomColor:"#CCC", paddingBottom:6, marginBottom:20}}>
                    ...
                    <Text style={{marginLeft:15,fontWeight:500}}>{ arrTenSp}</Text>
          ...
          <View style={{flexDirection:"row", alignItems:"center",justifyContent:"space-around"}}>
            ...
            :
            <TouchableRipple onPress={()=>{navigation.navigate('Home',0)} } style={{backgroundColor:"#66a182", width:150, padding:10, borderRadius:10}}>
